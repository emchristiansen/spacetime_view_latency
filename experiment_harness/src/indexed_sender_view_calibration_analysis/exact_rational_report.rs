...
///
/// **The exact domain is exactly what `i128` represents, and nothing narrower.** No ceiling is
...
/// series whose two central order statistics sum beyond `i128` is outside what this projection can
/// state, and says so loudly.
