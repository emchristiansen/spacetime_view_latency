...
/// attempt, so a half-observed attempt is a shape this type simply cannot hold. An attempt that never
/// ran carries no value of this type at all rather than a value with holes in it.
///
