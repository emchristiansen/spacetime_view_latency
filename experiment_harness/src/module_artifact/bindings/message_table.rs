...
/// Lifetime-aware accessor marker for the table `message`.
pub struct MessageTableAccessor;

impl __sdk::TableAccessor<super::RemoteTables> for MessageTableAccessor {
    type Row = Message;
    type Handle<'db> = MessageTableHandle<'db>;
...
impl<'ctx> __sdk::TableLike for MessageTableHandle<'ctx> {
    type Row = Message;
...
impl<'ctx> __sdk::WithInsert for MessageTableHandle<'ctx> {
    type InsertCallbackId = MessageInsertCallbackId;
...
impl<'ctx> __sdk::WithDelete for MessageTableHandle<'ctx> {
    type DeleteCallbackId = MessageDeleteCallbackId;
...
impl<'ctx> __sdk::WithUpdate for MessageTableHandle<'ctx> {
    type UpdateCallbackId = MessageUpdateCallbackId;
