...
/// process, data/keys dirs, listen address/URL, database identity) only for internal consistency,
/// shape, and reference binding — or fails loud. Homogeneity is field-specific, never whole-manifest
/// equality.
